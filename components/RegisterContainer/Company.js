  ...
  return (
    <Flex vertical gap={28} className={styles.container}>
      <Flex vertical gap={12} style={{ width: '100%' }}>
        ...
        <textarea placeholder={t('register.company.namePlaceholder')} className={styles.input} onChange={onChangeName} />
      </Flex>
      ...
      <Flex vertical gap={12} style={{ width: '100%' }}>
        ...
        <textarea placeholder={t('register.company.websitePlaceholder')} className={styles.input} onChange={onChangeUrl} />
      </Flex>
    </Flex>
  );
}
